...
public class Grille {
    ...
    public Grille() {
        ...
        tuiles[1][1] = new Tresor(NomTuile.CAVERNEOMBRES, EtatTuile.ASSECHEE,1,1, NomTresors.CRISTAL);
        ...
        tuiles[2][5] = new Tresor(NomTuile.JARDINHURLEMENTS, EtatTuile.ASSECHEE,2,5, NomTresors.ZEPHYR);
        ...
        tuiles[3][5] = new Tresor(NomTuile.CAVERNEBRASIER, EtatTuile.ASSECHEE,3,5, NomTresors.CRISTAL);
        ...
        tuiles[5][3] = new Tresor(NomTuile.JARDINMURMURES, EtatTuile.ASSECHEE,5,3, NomTresors.ZEPHYR);
