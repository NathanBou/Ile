...
public class Grille {
    ...
    public Grille() {
        ...
        tuiles[3][5] = new Tuile(NomTuile.CAVERNEBRASIER, EtatTuile.ASSECHEE,3,5);
        ...
        tuiles[4][2] = new Tuile(NomTuile.TEMPLELUNE, EtatTuile.ASSECHEE,4,2);
        ...
        tuiles[5][3] = new Tuile(NomTuile.JARDINMURMURES, EtatTuile.ASSECHEE,5,3);
